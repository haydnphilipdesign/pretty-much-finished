import { Home, Building, User, DollarSign, FileText, Shield, FileSignature, Info } from "lucide-react";
import { cn } from "@/lib/utils";
import { motion } from "framer-motion";
import { sidebarItemVariants } from "./animations";
...
export function FormSidebar({ currentStep, onStepClick }: FormSidebarProps) {
  return (
    <motion.div
      className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 p-6"
