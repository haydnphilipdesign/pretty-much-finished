  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden bg-black persistent-background">
        ...
        <div className="absolute inset-0 z-5 bg-gradient-to-b from-black/85 via-black/80 to-black/90">
          <div className="absolute inset-0 opacity-15 pattern-dots" />
        </div>

        {/* Additional overlay layer */}
        <div className="absolute inset-0 z-4 bg-black/40 mix-blend-overlay"></div>
      </div>
    </>
  );
};
