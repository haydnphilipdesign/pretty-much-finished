        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
          ...
          <div className="col-span-full mt-12 mb-2 text-center">
            <motion.div
              ...
              className="inline-block px-6 py-1.5 bg-white/10 rounded-full"
            >
              <h3 className="text-white/90 text-xl font-medium">Real Estate & Title Industry (2000-2006)</h3>
            </motion.div>
          </div>
          ...
          <div className="col-span-full mt-12 mb-2 text-center">
            <motion.div
              ...
              className="inline-block px-6 py-1.5 bg-white/10 rounded-full"
            >
              <h3 className="text-white/90 text-xl font-medium">Specialist & Business Owner (2006-Present)</h3>
            </motion.div>
          </div>
