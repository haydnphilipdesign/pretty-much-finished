    ...
    <div className="min-h-screen">
      ...
      <ContentSection dark={false} className="py-24 relative overflow-hidden" centered={true}>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700 max-w-3xl">Comprehensive solutions to streamline your real estate transactions</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <ContentCard
              ...
              className="glass-card-light h-full"
            >
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700 max-w-3xl">In-depth information about our specialized real estate support services</p>
        </div>
