...
const OUTPUT_DIR = path.join(process.cwd(), 'public', 'generated-pdfs');
...
// Generate cover sheet and optionally send email
export async function generateCoverSheet(req, res) {
    try {
...
export default async function handler(req, res) {
    ...
    return generateCoverSheet(req, res);
}