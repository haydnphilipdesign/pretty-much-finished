...
export function TransactionForm() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <div className="relative min-h-screen bg-gradient-to-b from-blue-700 to-blue-900 pb-20">
          {/* Step wizard at top */}
          <div className="sticky top-0 z-30 bg-gradient-to-b from-blue-700 to-blue-700/95 shadow-md rounded-b-xl">
            <StepWizard 
