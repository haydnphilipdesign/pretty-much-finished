...
export const generateMockFormData = (): TransactionFormData => {
  ...
  return {
    ...
    commissionBase: randomPick<CommissionBase>(["salePrice", "netPrice"]),
    totalCommission,
    ...
    buyerPaidCommission: randomCurrency(0, 5000),

    // Referral Information
    referralParty: Math.random() > 0.5 ? faker.company.name() : "",
    brokerEIN: Math.random() > 0.5 ? faker.string.numeric(9) : "",
