    ...
    <div className="bg-gray-50">
      ...
      <section className="py-20 bg-indigo-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            to="/work-with-me"
            className="inline-flex items-center px-8 py-4 bg-brand-gold text-white rounded-xl font-semibold hover:bg-brand-gold/90 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Get Started
          </Link>
        </div>
