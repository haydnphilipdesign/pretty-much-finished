...
export function TransactionForm() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!signatureData?.agentName) {
        throw new Error("Agent name signature is required");
      }
          ...
          >
            <div className="py-4 px-8">
              ...
              <div className="p-4 md:p-6">
                ...
                {currentStep === 6 && (
                  <DocumentsSection 
                    role={formData.role || 'DUAL AGENT'} // Provide default value
                    titleData={formData.titleData}
                    propertyData={formData.propertyData}
                    commissionData={formData.commissionData}
                    onChange={(field, value) => {
                      // Ensure this is a function that accepts two parameters
