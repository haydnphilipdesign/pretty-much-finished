...
export const useTransactionForm = () => {
  ...
  const handleNext = () => {
    ...
    if (Object.keys(errors).length === 0 || bypassValidationMode) {
      ...
      // Create a simplified toast with a clear option to proceed
      toast({
        title: `Missing Information (${errorCount})`,
        description: "Some information is missing. Click the buttons below to continue anyway or fix the issues.",
        variant: "destructive",
