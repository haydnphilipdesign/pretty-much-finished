...
const templateMap = {
    ...
    totalCommissionPercent: "totalCommission", // Added for template formatting
    listingAgentPercentage: "listingAgentPercentage",
    listingAgentPercent: "listingAgentPercentage", // Added for template formatting
    buyersAgentPercentage: "buyersAgentPercentage",
    buyersAgentPercent: "buyersAgentPercentage", // Added for template formatting
    brokerFee: "brokerFee",
    ...
    // Client information (placeholders for demo)
    buyerName: "Test Buyer",
    buyerAddress: "456 Buyer St, Philadelphia, PA 19103",
    buyerPhone: "(215) 555-1234",
    buyerEmail: "buyer@example.com",

    sellerName: "Test Seller",
    sellerAddress: "789 Seller St, Philadelphia, PA 19103",
    sellerPhone: "(215) 555-5678",
    sellerEmail: "seller@example.com",

    // Other information seen in templates
    attorneyName: "Example Law Firm",
    titleCompany: "ABC Title Company",

    // HOA and municipality information
    hoaAssociation: "Example HOA",
    hoaYes: true,
    hoaNo: false,
...
function formatDataForTemplate(data) {
    ...
    for (const [templateField, dataField] of Object.entries(templateMap)) {
        // Handle direct value assignments (strings, booleans, etc.)
        if (typeof dataField !== 'string' || !data[dataField]) {
            templateData[templateField] = dataField;
            continue;
        }

        // Handle fields that come from transaction data
        if (data[dataField]) {
