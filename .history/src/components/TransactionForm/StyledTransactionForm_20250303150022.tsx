            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all ${((state.selectedRole as unknown) as string) === "buyersAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all ${((state.selectedRole as unknown) as string) === "listingAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 transition-all ${((state.selectedRole as unknown) as string) === "dualAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                  <div className="flex flex-col items-center text-center space-y-4">
