...
export const generateTransactionPdf = async (formData: any): Promise<string> => {
  ...
  try {
    ...
    const EMAILJS_USER_ID = import.meta.env.VITE_EMAILJS_USER_ID || 'user_your_emailjs_user_id';
    const EMAILJS_SERVICE_ID = import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_your_emailjs_service_id';
    const EMAILJS_TEMPLATE_ID = import.meta.env.VITE_EMAILJS_TEMPLATE_ID || 'template_your_emailjs_template_id';
