...
export const formFieldPositions = {
  ...
  page1: {
    ...
    totalPercentage: { x: 113.13, y: 236.38 + Y_OFFSET + 2, fontSize: 11, bold: true },
    
    // Title Information - Move DOWN by 14.9 points (half of 29.8)
    titleCompany: { x: 270.59, y: 163.71 + Y_OFFSET + 2, fontSize: 11, bold: true },
  ...
  page2: {
    ...
    municipality: { x: 55, y: 250 + Y_OFFSET, fontSize: 9, bold: true },
