    ...
    try {
      ...
      const formData: TransactionFormData = {
        ...
        propertyDetailsData: {
          ...
          hasBasement: true,
          hasPool: false,
          schoolDistrict: 'Example School District'
        },
        titleData: {
          titleCompany: 'Example Title Company',
          titleContactName: 'Jane Doe',
          titleContactEmail: 'jane@example.com',
          titleContactPhone: '555-987-6543',
          escrowNumber: 'ESC12345',
          titleOrderedDate: '2023-11-15'
        },
        signatureData: {
          signingDate: '2023-12-15',
          signingLocation: 'Title Company Office',
          signingContactName: 'Sarah Johnson',
          signingContactEmail: 'sarah@example.com',
          signingContactPhone: '555-789-1234'
        },
        documentsData: {
          hasAgreementOfSale: true,
          hasSellerDisclosure: true,
          hasLeadBasedPaintDisclosure: false,
          hasPropagandaBrochure: true,
          hasCommunityDocuments: false
        },
        clients: [
          {
            id: '1',
