import { TransactionFormData, CommissionBase, TCFeePaidBy, AccessType } from "../components/TransactionForm/types";
...
export const submitToAirtable = async (formData: TransactionFormData, apiKey: string) => {
  ...
  // Only add the Required Documents field if we have valid documents
  if (formattedDocuments.length > 0) {
    record.fields["Required Documents"] = formattedDocuments;
  }
