...
import { Menu, X, User, Home, FileText, Info, BookOpen } from 'lucide-react';
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <Link
                        to="/work-with-me"
                        className="flex items-center justify-center w-full px-8 py-4 bg-brand-blue text-white rounded-lg hover:bg-blue-600 transition-colors"
                      >
                        Work With Me
                      </Link>
                    </motion.div>
