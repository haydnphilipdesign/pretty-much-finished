                  ...
                  <ScrollToTopLink
                    ...
                    className={`relative font-medium group flex items-center px-4 py-2 rounded-full ${
                      location.pathname === item.path
                        ? 'dark-bg-text font-semibold bg-black/40'
                        : 'dark-bg-text hover:text-brand-gold bg-black/30 hover:bg-black/40'
                    } ${item.path === '/agent-portal' ? 'px-6 py-2 bg-gradient-to-r from-brand-gold to-yellow-500 text-brand-blue hover:dark-bg-text rounded-lg hover:shadow-lg transition-all duration-300' : ''}`}
                  >
              ...
              <button
                ...
                className={`relative z-50 p-2 rounded-full transition-colors ${
                  scrolled || isOpen
                    ...
                    : 'dark-bg-text hover:text-brand-gold'
                }`}
                    ...
                    {navItems.map((item) => (
                      ...
                      >
                        <ScrollToTopLink
                          ...
                          } ${item.path === '/agent-portal' ? 'bg-gradient-to-r from-brand-gold to-brand-blue dark-bg-text hover:shadow-lg' : ''}`}
                        >
