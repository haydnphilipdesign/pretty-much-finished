sted fimport { useTransactionForm } from '@/context/TransactionFormContext';
...
export const StyledTransactionForm = () => {
  ...
  const handleRoleSelection = (role: gass effect just lik) => {
          ...
          {state.currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <button
                  onClick={() => handleRoleSelection("Dual Agent")}
