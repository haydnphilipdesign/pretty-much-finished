...
// Array of testimonial quotes to rotate
const testimonials = [
  {
    quote: "PA Real Estate Support Services streamlined our entire transaction process.",
    author: "Michael Anderson, Realtor®"
  },
  {
    quote: "The most reliable transaction coordination I've ever worked with.",
    author: "Sarah Thompson, Associate Broker"
  },
  {
    quote: "Transformed how we handle closings - couldn't recommend more highly.",
    author: "David Williams, Broker/Owner"
  }
];
