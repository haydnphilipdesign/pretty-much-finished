        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {journeySteps.map((step, index) => (
            ...
            >
              ...
              <div className="relative bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                <div className="mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2 min-h-[3rem] flex items-center group-hover:text-brand-blue transition-colors">
                  {step.title}
                </h3>
                <p className="text-gray-600 text-sm flex-grow group-hover:text-gray-900 transition-colors">
                  {step.description}
                </p>
              </div>
            </motion.div>
