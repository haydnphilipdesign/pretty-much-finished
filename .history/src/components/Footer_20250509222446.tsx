...
import { Phone, Mail, MapPin, ExternalLink, ChevronRight, Heart, Clock, Calendar } from 'lucide-react';
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-blue-50 to-blue-100/50 border-t border-blue-100 overflow-hidden mt-auto w-full">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
          ...
          <motion.div variants={itemVariants} className="md:col-span-3">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="tel:+5705884637"
                  className="flex items-center text-gray-600 hover:text-blue-600 transition-colors duration-300 group text-sm"
                >
                  <div className="bg-gray-100 group-hover:bg-blue-100 p-1.5 rounded-full mr-2 transition-colors duration-300">
                    <Phone className="w-3 h-3 text-gray-600 group-hover:text-blue-600 transition-colors duration-300" />
                  </div>
              ...
              <li>
                ...
                >
                  <div className="bg-gray-100 group-hover:bg-blue-100 p-1.5 rounded-full mr-2 transition-colors duration-300">
                    <Mail className="w-3 h-3 text-gray-600 group-hover:text-blue-600 transition-colors duration-300" />
                  </div>
            ...
            {/* Office hours - moved below contact info */}
        ...
        <motion.div
          ...
          className="mt-8 md:mt-10 pt-4 md:pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center"
        >
