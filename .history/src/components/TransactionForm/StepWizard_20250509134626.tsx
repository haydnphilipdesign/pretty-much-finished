    ...
    <div className={containerClass}>
      {steps.map((step, index) => {
        ...
        if (variant === 'pills') {
          switch (stepStatus) {
            case 'completed':
              stepColors = 'bg-blue-50 text-blue-600 border-blue-200';
              break;
            case 'current':
              stepColors = 'bg-blue-100 text-blue-700 border-blue-300 font-medium';
              break;
            default:
              stepColors = 'bg-gray-50 text-gray-500 border-gray-200';
              break;
          }
        }
              ...
              {showLabels && (
                <span
                  className={cn(
                    ...
                    stepStatus === 'current' ? 'text-blue-700 font-medium' : 'text-gray-500',
