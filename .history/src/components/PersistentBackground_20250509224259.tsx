...
const PersistentBackground: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden bg-brand-blue persistent-background">
        ...
        <AnimatePresence initial={false} mode="sync">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/50 via-black/40 to-blue-800/50" />
            ...
            >
              <img
                ...
                style={{
                  ...
                  filter: 'saturate(1.2) brightness(0.85) contrast(1.15) hue-rotate(-10deg)'
                }}
              />
            </motion.div>
          </motion.div>
        ...
        {/* Enhanced blue overlay */}
        <div className="absolute inset-0 z-5 bg-gradient-to-b from-blue-900/60 via-blue-800/50 to-blue-950/70">
          <div className="absolute inset-0 opacity-20 pattern-dots" />
        </div>

        {/* Additional blue tint layer */}
        <div className="absolute inset-0 z-4 bg-blue-600/25 mix-blend-overlay"></div>
      </div>
    </>
  );
};
