import { Building, User, DollarSign, FileText, Shield, Building2, FileSignature, Info } from "lucide-react";
...
const steps = [
  ...
  { id: 3, title: "Commission", icon: DollarSign },
  { id: 4, title: "Property Details", icon: Info },
  { id: 5, title: "Warranty", icon: Shield },
  { id: 6, title: "Title Company", icon: Building2 },
  { id: 7, title: "Documents", icon: FileText },
  { id: 8, title: "Additional Info", icon: Info },
  { id: 9, title: "Sign & Submit", icon: FileSignature },
];
