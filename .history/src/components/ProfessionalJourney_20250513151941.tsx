      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {journeySteps.map((step, index) => (
            ...
            >
              <div className="absolute -inset-0.5 bg-gradient-to-r from-brand-gold to-white rounded-xl blur opacity-30 group-hover:opacity-70 transition duration-300" />
              <div className="relative bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col group-hover:bg-gray-50">
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2 min-h-[3rem] flex items-center group-hover:text-brand-blue">
                  {step.title}
                </h3>
                <p className="text-gray-600 text-sm flex-grow group-hover:text-gray-800">
                  {step.description}
                </p>
              </div>
            </motion.div>
