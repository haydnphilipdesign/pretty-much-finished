  ...
  return (
    <div className="agent-portal-form-container">
      ...
      <PortalTransactionForm
        ...
        agentId={agent.id}
        logo="C:\Users\haydn\OneDrive\Documents\Development\Projects\PA REAL ESTATE SUPPORT\pa-real-estate-support-services\public\logo-flat.png" // Update with your actual logo path
      />
    </div>
  );
};
