            ...
            <div className="bg-white shadow-xl rounded-xl p-6 sm:p-8 border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  ...
                  {currentStep === 8 && "Review transaction details and sign."}
                </p>
              </div>
              ...
              <div className="space-y-6">
                {currentStep === 1 && (
                  <RoleSelection
                    data={agentData}
                    onChange={(field, value) => setAgentData(prev => ({ ...prev, [field]: value }))}
                  />
                )}
                {currentStep === 2 && (
                  <PropertyInformation
                ...
                {currentStep === 5 && (
                  <PropertyDetailsSection
                    ...
                    titleData={titleData}
                    onTitleDataChange={(field, value) => setTitleData(prev => ({ ...prev, [field]: value }))}
                  />
                )}
                {currentStep === 6 && (
                  <DocumentsSection
