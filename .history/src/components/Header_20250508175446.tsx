              ...
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    ...
                    } ${item.path === '/agent-portal' ? 'px-6 py-2 bg-gradient-to-r from-brand-gold to-yellow-500 text-brand-blue rounded-lg hover:shadow-lg transition-all duration-300' : ''}`}
                  >
