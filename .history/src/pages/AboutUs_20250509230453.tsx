...
const CoreValue = ({ title, description, icon: Icon }: { title: string; description: string; icon: React.ComponentType<any> }) => (
  ...
  >
    ...
    <div className="relative glass-card p-8 h-full transform group-hover:shadow-xl transition-all duration-300">
  ...
  return (
    <div className="relative bg-transparent">
      ...
      >
        <Link
          to="/work-with-me"
          className="inline-flex items-center mt-6 px-6 py-3 rounded-full glass-card text-white font-medium transition-all duration-300"
        >
          Get in Touch
      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center relative z-10">
          ...
          <Link
            to="/work-with-me"
            className="group inline-flex items-center px-8 py-4 text-lg font-medium text-brand-blue bg-white rounded-full shadow-lg hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 glass-card"
          >
            Get in Touch
            <motion.div
              className="ml-2"
