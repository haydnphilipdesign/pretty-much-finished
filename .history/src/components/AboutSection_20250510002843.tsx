...
const AboutSection: React.FC = () => {
  ...
  return (
    <ContentSection dark={false} className="py-20 overflow-x-hidden max-w-full">
      <div className="grid md:grid-cols-2 gap-6 lg:gap-4 items-center">
        ...
        >
          ...
          >
            ...
            >
              <h3 className="glass-card-title text-2xl md:text-3xl font-bold text-brand-blue leading-tight break-words">
                Transforming Complex Transactions into Seamless Success Stories
              </h3>
              <p className="glass-card-subtitle text-md text-gray-600 italic">
            ...
            >
              <p className="glass-card-content text-gray-600 leading-relaxed text-sm md:text-base">
