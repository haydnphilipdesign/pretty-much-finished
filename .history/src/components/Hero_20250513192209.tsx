      ...
      <div className="container px-4 md:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            >
              ...
              <motion.div
                ...
                transition={{
                  duration: 0.6,
                  delay: 0.2,
                  exit: { duration: 0.6, delay: 0 } // No delay on exit
                }}
              ...
              <motion.div
                ...
                transition={{
                  duration: 0.6,
                  delay: 0.3,
                  exit: { duration: 0.6, delay: 0.1 } // Slight delay on exit for staggered effect
                }}
                style={{ willChange: "opacity, transform" }}
              ...
              <motion.div
                ...
                transition={{
                  duration: 0.6,
                  delay: 0.4,
                  exit: { duration: 0.6, delay: 0.2 } // Slight delay on exit for staggered effect
                }}
                style={{ willChange: "opacity, transform" }}
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: 50 }} {/* Already matching, but let's ensure consistent timing */}
            transition={{
              duration: 0.8,
              delay: 0.6,
              exit: { duration: 0.8, delay: 0.3 } // Slight delay on exit for staggered effect
            }}
          >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: 30 }} {/* Match entrance animation exactly */}
          transition={{
            duration: 0.8,
            delay: 0.8,
            exit: { duration: 0.8, delay: 0.4 } // Slight delay on exit for staggered effect
          }}
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              transition={{
                duration: 0.5,
                delay: 0.9 + index * 0.1,
                exit: { duration: 0.5, delay: 0.2 + index * 0.05 } // Half the stagger time for exit
              }}
            >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -10 }} {/* Match entrance animation exactly */}
          transition={{
            duration: 0.6,
            delay: 1.5,
            exit: { duration: 0.4, delay: 0 }, // Quick exit for this element
            y: {
              duration: 1.5,
              repeat: Infinity,
              repeatType: "reverse"
        ...
        >
          <div className="flex items-center glass-card-navy rounded-full px-4 py-2">
