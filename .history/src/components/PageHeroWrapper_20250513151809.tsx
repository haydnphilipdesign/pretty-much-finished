          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <span className="bg-brand-gold/20 p-1.5 rounded-full mr-2 flex-shrink-0 flex items-center justify-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <motion.h1
                ...
                exit={{ opacity: 0, y: -20 }}
                transition={{ duration: 0.8, delay: 0.4 }} // Increased delay from 0.2 to 0.4
              ...
              {subtitle && (
                <motion.p
                  className="text-xl md:text-2xl mb-6 md:mb-8 text-blue-50 font-light text-shadow-sm text-center lg:text-left"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ duration: 0.8, delay: 0.6 }} // Increased from 0.3 to 0.6
                  style={{ willChange: "opacity, transform" }}
              ...
              {children && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ duration: 0.8, delay: 0.8 }} // Increased from 0.4 to 0.8
                  style={{ willChange: "opacity, transform" }}
