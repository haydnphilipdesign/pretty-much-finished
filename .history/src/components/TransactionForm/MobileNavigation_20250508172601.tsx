  ...
  return (
    ...
    >
      ...
      <div className="h-1 absolute top-0 left-0 w-full bg-gray-100 -translate-y-1">
        <motion.div 
          ...
          className={cn(
            "h-full",
            hasMissingFields
              ? "bg-gradient-to-r from-blue-600 via-red-500 to-brand-blue"
              : "bg-gradient-to-r from-blue-600 to-brand-blue"
          )}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        <Button
          ...
          className={cn(
            ...
            "border-gray-200 text-gray-700 hover:text-brand-blue hover:border-blue-200 hover:bg-blue-50"
          )}
        >
        ...
        {onSave && (
          <Button
            ...
            size="sm"
            onClick={onSave}
            className="px-3 h-10 rounded-full border-blue-200 bg-blue-50 text-brand-blue hover:bg-blue-100"
          >
        ...
        <Button
          ...
          className={cn(
            "flex items-center px-3 h-10 rounded-full",
            isLastStep 
              ? "bg-gradient-to-r from-blue-600 to-brand-blue hover:shadow-md text-white" 
              : "bg-gradient-to-r from-blue-600 to-brand-blue hover:shadow-md text-white",
      ...
      <div className="text-center text-xs text-gray-500 mt-2">
        ...
        {hasMissingFields && (
          <span className="text-red-500 ml-1">• Some fields missing</span>
        )}
      </div>
    </motion.div>
  );
