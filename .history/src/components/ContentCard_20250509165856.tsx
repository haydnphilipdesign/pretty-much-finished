...
const ContentCard: React.FC<ContentCardProps> = ({
  ...
  if (heroStyle) {
    baseCardStyle += ' bg-white/10 backdrop-blur-sm border border-white/20 p-6 shadow-lg';
  } else if (dark) {
    baseCardStyle += ' bg-brand-blue/10 backdrop-blur-sm border border-brand-blue/20 p-6 shadow-md hover:shadow-lg';
  } else {
