        ...
        <nav className="py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center">
              <div className={`flex space-x-1 p-1 rounded-full ${isScrolled || isAgentPortal ? 'bg-gray-100' : 'bg-black/20 backdrop-blur-sm'}`}>
                    ...
                    className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center ${
                      location.pathname === link.path
                        ...
                        : isScrolled || isAgentPortal
                            ...
                            : 'text-white hover:bg-white/30 shadow-sm'
                    }`}
                  >
              ...
              >
                <div className="px-5 py-6 space-y-2">
                  ...
                  >
                    <Link
                      to="/agent-portal"
                      className="flex items-center justify-center w-full py-3 px-4 bg-blue-500 text-white font-medium rounded-xl shadow-md hover:bg-blue-600 transition-colors"
                    >
