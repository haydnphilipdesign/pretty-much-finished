  ...
  return (
    <div className="example-integration" style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <p>
        ...
        When you submit the form, the data is sent to Airtable and a cover sheet is automatically 
        generated and emailed to administration.
      </p>
      ...
      {submitted && transactionId && (
        <div className="success-message" style={{ marginTop: '20px', padding: '10px', border: '1px solid #4CAF50', borderRadius: '4px', backgroundColor: '#f0f8f0' }}>
          ...
          <p>A cover sheet has been automatically generated and sent to administration.</p>
          
          <div style={{ marginTop: '15px', padding: '10px', backgroundColor: '#dff0d8', borderRadius: '4px' }}>
            <h4>Need Another Copy?</h4>
            <p>If you need to generate another cover sheet for this transaction:</p>
            <CoverSheetButton 
              transactionId={transactionId} 
              agentRole={agentRole}
              className="primary-button"
              buttonText="Send Another Cover Sheet"
            />
          </div>
        </div>
      )}
      ...
      <div className="explanation" style={{ marginTop: '30px', padding: '15px', backgroundColor: '#f9f9f9', borderRadius: '4px' }}>
        <h2>How It Works</h2>
        <p>
          The cover sheet generation is integrated directly into the form submission process:
        </p>
        <ol>
          <li>When the form is submitted, data is sent to Airtable using the <code>submitToAirtable</code> function</li>
          <li>After successful submission, the system automatically starts generating a cover sheet in the background</li>
          <li>The PDF is generated based on the agent role and transaction data</li>
          <li>The generated cover sheet is automatically emailed to administration (debbie@parealestatesupport.com)</li>
          <li>The process happens silently without requiring any user interaction</li>
        </ol>
        <p>
          This approach simplifies the process by making PDF generation a natural extension of form submission,
          with no need for separate steps or user intervention. The user doesn't need to download or handle the PDF.
        </p>
      </div>
    </div>
  );
