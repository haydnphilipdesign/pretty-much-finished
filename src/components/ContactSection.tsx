...
const ContactSection: React.FC = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-b from-blue-700 to-blue-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {contactInfo.map((item) => (
            <ContentCard
              ...
              className="h-full flex flex-col items-center text-center border-t-2 border-[#FFB81C]/60"
              iconContent={
