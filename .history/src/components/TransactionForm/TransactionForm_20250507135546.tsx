...
export function TransactionForm() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <div className="relative min-h-screen bg-gradient-to-b from-sky-800 to-teal-700 pb-20">
          {/* Step wizard at top */}
          <div className="sticky top-0 z-30 bg-gradient-to-b from-sky-800 to-sky-800/95 shadow-md rounded-b-xl">
            <StepWizard 
