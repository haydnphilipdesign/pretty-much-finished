...
const mockFormData = {
  ...
  commissionData: {
    ...
    listingAgentCommission: '3.00',
    buyersAgentCommission: '3.00',
    hasBrokerFee: true,
    brokerFeeAmount: '2500.00',
    buyerPaidAmount: '1500.00',
    sellerPaidAmount: '1000.00',
    hasSellersAssist: true,
    sellersAssist: '5000.00',
    isReferral: 'YES',
    referralParty: 'ABC Referral Company',
    brokerEin: '12-3456789',
    referralFee: '25.00',
    coordinatorFeePaidBy: 'listing_agent'
  },
  propertyDetails: {
