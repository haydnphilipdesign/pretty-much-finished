...
function mapFormDataToPositions(formData) {
    ...
    // Always include municipality data in PDF if it exists, regardless of coRequired flag
    if (formData.propertyDetailsData && formData.propertyDetailsData.municipality) {
        textElements.push({
            page: 1,
            x: 60,
            y: 245 + Y_OFFSET,
            text: formData.propertyDetailsData.municipality,
            fontSize: 9,
            isBold: true
        });
    } else if (formData.propertyDetails && formData.propertyDetails.municipality) {
        // For backward compatibility - some data might use propertyDetails instead of propertyDetailsData
        textElements.push({
            page: 1,
            x: 60,
            y: 245 + Y_OFFSET,
    ...
    if (formData.propertyDetailsData && formData.propertyDetailsData.hoaName) {
        textElements.push({
            page: 1,
            x: 45,
            y: 350 + Y_OFFSET,
            text: formData.propertyDetailsData.hoaName,
            fontSize: 9,
            isBold: true
        });
    } else if (formData.propertyDetails && formData.propertyDetails.hoaName) {
