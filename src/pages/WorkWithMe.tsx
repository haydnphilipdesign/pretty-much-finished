              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-800">Personalized service tailored to your specific needs</p>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle className="text-brand-blue mr-4 mt-1 flex-shrink-0" />
                    <p className="text-gray-800">Quick response times to keep your transactions moving</p>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle className="text-brand-blue mr-4 mt-1 flex-shrink-0" />
                    <p className="text-gray-800">Flexible packages to accommodate your business volume</p>
                  </div>
                </div>
              </PreloadedAnimationWrapper>
