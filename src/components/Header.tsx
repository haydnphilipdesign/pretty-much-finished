          ...
          <nav className="flex items-center justify-between h-20">
              ...
              {navItems.map((item, index) => (
                ...
                >
                  <ScrollToTopLink
                    to={item.path}
                    style={{
                      color: item.path === '/agent-portal' ? '#111827' : '#ffffff',
                      textShadow: item.path === '/agent-portal' ? 'none' : '0 1px 4px rgba(0, 0, 0, 0.8)'
                    }}
                    className={`relative font-semibold group flex items-center px-4 py-2 rounded-full ${
                      location.pathname === item.path
                        ? 'text-white !important font-semibold bg-black/70 [text-shadow:_0_1px_3px_rgba(0,0,0,0.8)] !important'
                        : 'text-white !important hover:text-white bg-black/60 hover:bg-black/70 [text-shadow:_0_1px_3px_rgba(0,0,0,0.8)] !important'
                    } ${item.path === '/agent-portal' ? 'px-6 py-2 bg-amber-500 !important hover:bg-amber-600 !important text-gray-900 !important hover:text-gray-900 !important font-semibold rounded-lg hover:shadow-lg transition-all duration-300' : ''}`}
                  >
            ...
            >
              <button
                ...
                className="p-2 rounded-full bg-black/60 text-white hover:bg-black/70 hover:text-white transition-colors duration-200"
                    ...
                    >
                      <ScrollToTopLink
                        ...
                        className={`flex items-center px-4 py-3 rounded-lg ${
                          location.pathname === item.path
                            ? 'bg-black/70 text-white !important font-semibold [text-shadow:_0_1px_3px_rgba(0,0,0,0.8)] !important'
                            : 'text-white !important hover:bg-black/60 hover:text-white !important [text-shadow:_0_1px_3px_rgba(0,0,0,0.8)] !important'
                        } ${item.path === '/agent-portal' ? 'mt-4 bg-amber-500 !important text-gray-900 !important hover:bg-amber-600 !important hover:text-gray-900 !important' : ''}`}
