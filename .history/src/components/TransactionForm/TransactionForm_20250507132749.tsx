...
export function TransactionForm() {
  ...
  // Helper function to get all skipped fields as a simple array
  const getAllSkippedFields = (): string[] => {
    if (!skippedFields || skippedFields.length === 0) return [];
    
    // Flatten the array of objects into a single array of field names
    return skippedFields.reduce((allFields: string[], stepFields) => {
      return [...allFields, ...stepFields.fields];
    }, []);
  };
                    ...
                    {currentStep === 8 && (
                      <>
                        <ReviewSection 
                          ...
                          skippedFields={getAllSkippedFields()}
