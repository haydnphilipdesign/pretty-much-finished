        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className={`bg-white/80 border-slate-300 text-slate-800 placeholder:text-slate-400 ${errors.companyName ? 'border-red-500' : ''}`}
              aria-invalid={!!errors.companyName}
              aria-describedby={errors.companyName ? "companyName-error" : undefined}
            />
            {errors.companyName && <p id="companyName-error" className="text-sm text-red-500 mt-1">{errors.companyName}</p>}
          </div>
