    ...
    <GlobalPageHero>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
        ...
        <div className="lg:col-span-3">
          <motion.div
            className="max-w-2xl p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              <div className="hero-badge mb-4 inline-flex items-center px-3 py-1 rounded-full bg-white/20 backdrop-blur-sm text-sm font-medium">
            ...
            >
              <h1 className="hero-headline text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 leading-tight text-white">
            ...
            >
              <p className="hero-subheadline text-xl md:text-2xl mb-6 md:mb-8 text-blue-100 font-light">
