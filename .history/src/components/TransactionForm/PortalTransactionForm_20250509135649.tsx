      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-start pt-4">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-24">
          ...
          >
            ...
            <motion.div
              className="hidden lg:block mt-8 bg-white/10 backdrop-blur-sm rounded-lg p-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        <div className="lg:col-span-8">
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-md rounded-xl p-4 lg:p-6 shadow-xl mb-16"
          >
            <TransactionForm />
          </motion.div>
        </div>
