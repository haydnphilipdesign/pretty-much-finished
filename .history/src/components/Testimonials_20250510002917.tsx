...
const Testimonials = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden max-w-full bg-white">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="md:w-2/3 p-6 md:p-8 flex flex-col justify-center">
                  <div className="mb-4">
                    <h3 className="glass-card-title text-xl md:text-2xl font-bold text-brand-blue">
                      {testimonialData[currentIndex].name}
                    </h3>
                    <p className="glass-card-subtitle text-brand-blue/70 text-sm">
                      {testimonialData[currentIndex].role}
                    </p>
                  </div>

                  <div className="relative">
                    <blockquote className="glass-card-content text-gray-700 mb-4 relative z-10 text-base leading-relaxed overflow-auto max-h-[240px] pr-4">
