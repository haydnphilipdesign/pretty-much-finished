...
function mapFormDataToPdfPositions(formData) {
    ...
    const mappedData = {
        propertyData: {
            ...
            closingDate: formData.propertyData ? .closingDate || '',
        ...
        commissionData: {
            totalCommission: formData.commissionData ? .totalCommission || '',
            listingAgentCommission: formData.commissionData ? .listingAgentCommission || '',
            buyersAgentCommission: formData.commissionData ? .buyersAgentCommission || '',
            brokerFeeAmount: formData.commissionData ? .brokerFeeAmount || '',
            buyerPaidAmount: formData.commissionData ? .buyerPaidAmount ||
                formData.commissionData ? .buyerPaidCommission || '',
            sellersAssist: formData.commissionData ? .sellersAssist || '',
            isReferral: formData.commissionData ? .isReferral || '',
            referralParty: formData.commissionData ? .referralParty || '',
            referralFee: formData.commissionData ? .referralFee || ''
        },
        clients: formData.clients || [],
        propertyDetails: {
            attorneyName: formData.propertyDetails ? .attorneyName || '',
            municipality: formData.propertyDetails ? .municipality || '',
            hoaName: formData.propertyDetails ? .hoaName || ''
        },
        titleData: {
