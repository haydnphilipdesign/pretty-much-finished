      ...
      <TooltipProvider>
        <div className="transaction-form-container flex flex-col">
          ...
          <div className="container mx-auto px-2 sm:px-6 py-4 sm:py-6">
            ...
            <div ref={formContentRef} className="modern-form-container bg-white/90 backdrop-blur-sm shadow-xl rounded-xl p-4 sm:p-8 border border-white/20 mb-20 md:mb-0 relative">
