      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center relative z-10">
          <div className="glass-card-navy max-w-4xl mx-auto">
            ...
            <Link
              to="/work-with-me"
              className="group inline-flex items-center px-8 py-4 text-lg font-medium text-blue-800 bg-white rounded-full shadow-lg hover:bg-blue-50 transition-all duration-300 hover:shadow-xl"
            >
              Get in Touch
              <motion.div
                className="ml-2"
