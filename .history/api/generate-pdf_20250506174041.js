    ...
    try {
        ...
        if (formData.commissionData) {
            ...
            if (formData.commissionData.totalCommission) {
                page.drawText(sanitizeText(`${formData.commissionData.totalCommission}`), {
                    x: 75,
                    y: 236.38 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.listingAgentCommission) {
                page.drawText(sanitizeText(`${formData.commissionData.listingAgentCommission}`), {
                    x: 75,
                    y: 289.24 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.buyersAgentCommission) {
                page.drawText(sanitizeText(`${formData.commissionData.buyersAgentCommission}`), {
                    x: 75,
                    y: 262.81 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.brokerFeeAmount) {
                page.drawText(sanitizeText(`$${formData.commissionData.brokerFeeAmount}`), {
                    x: 200,
                    y: 289.24 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.buyerPaidAmount) {
                page.drawText(sanitizeText(`$${formData.commissionData.buyerPaidAmount}`), {
                    x: 200,
                    y: 262.81 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
                ...
                page.drawText(sanitizeText(`$${formData.commissionData.buyerPaidCommission}`), {
                    x: 200,
                    y: 262.81 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.sellersAssist) {
                page.drawText(sanitizeText(`$${formData.commissionData.sellersAssist}`), {
                    x: 396.44,
                    y: 690.52 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (formData.commissionData.isReferral === 'YES' && formData.commissionData.referralParty) {
                ...
                if (formData.commissionData.referralFee) {
                    page.drawText(sanitizeText(`${formData.commissionData.referralFee}`), {
                        x: 264.81,
                        y: 57.99 + Y_OFFSET - 2,
                        size: 11,
                        font: fontBold
