          ...
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="mt-4 text-sm text-gray-900 bg-blue-100/50 p-3 rounded">
                  <p className="text-gray-900">As a {selectedRoleObj?.title.toLowerCase()}, you'll need to provide:</p>
