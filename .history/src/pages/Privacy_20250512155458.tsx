...
// Animation variants for item staggering only - no y movement
...
const Privacy: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white">
      <GlobalPageHero minHeight="min-h-screen">
        <div className="container px-4 md:px-6 lg:px-8 mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            {/* Add glass card for key privacy principles */}
            <div className="lg:col-span-5">
              ...
              >
                <h3 className="hero-card-title">Privacy Principles</h3>
      ...
      <PreloadedAnimationWrapper className="py-24" bg="bg-white">
