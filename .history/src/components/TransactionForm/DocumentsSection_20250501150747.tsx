...
export const DocumentsSection: React.FC<DocumentsSectionProps> = ({
  ...
  // Safe function to notify parent of changes
  ...
  }, [selectedDocuments, documentConfirmation, role, onChange]);

  // Call notifyParent when relevant state changes
  useEffect(() => {
    notifyParent();
  }, [selectedDocuments, documentConfirmation, notifyParent]);
