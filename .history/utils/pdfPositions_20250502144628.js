...
export const formFieldPositions = {
  ...
  page1: {
    ...
    buyerName: { x: 120.00, y: 494.06 + Y_OFFSET - 2, fontSize: 11, bold: true },
    buyerPhone: { x: 110.00, y: 467.63 + Y_OFFSET - 2, fontSize: 11 },
    buyerAddress: { x: 70.00, y: 441.20 + Y_OFFSET - 2, fontSize: 11 },
    buyerEmail: { x: 100.00, y: 414.77 + Y_OFFSET - 0, fontSize: 11 },
    
    // Seller Information section - Move DOWN by half the specified amounts and shifted left
    sellerName: { x: 390.00, y: 494.06 + Y_OFFSET - 2, fontSize: 11, bold: true },
    sellerPhone: { x: 385.00, y: 467.63 + Y_OFFSET - 2, fontSize: 11 },
    sellerAddress: { x: 340.00, y: 441.20 + Y_OFFSET - 2, fontSize: 11 }, // Shifted left from original
    sellerEmail: { x: 375.00, y: 414.77 + Y_OFFSET - 0, fontSize: 11 },
    ...
    buyerSidePercentage: { x: 113.13, y: 262.81 + Y_OFFSET + 2, fontSize: 11, bold: true },
