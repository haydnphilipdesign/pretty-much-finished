          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <PreloadedAnimationWrapper
                ...
                preloadDelay={300}
              >
                <div className="glass-card-white p-8 shadow-lg">
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        required
                        className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-blue-400 text-gray-800"
                      />
                    </div>
