...
async function fillPdfForm(formData) {
    try {
        ...
        if (formData.propertyData && formData.propertyData.salePrice) {
            page.drawText(sanitizeText(`$${formData.propertyData.salePrice}`), {
                x: 278.45,
                y: 690.52 + Y_OFFSET + 2,
                size: 11,
                font: fontBold
        ...
        if (formData.propertyData && formData.propertyData.closingDate) {
            page.drawText(sanitizeText(formData.propertyData.closingDate), {
                x: 440,
                y: 644.28 + Y_OFFSET + 2,
                size: 10,
                font: fontBold
        ...
        if (formData.propertyData && formData.propertyData.status) {
            page.drawText(sanitizeText(formData.propertyData.status), {
                x: 278.45,
        ...
        if (formData.propertyData && formData.propertyData.propertyType) {
            page.drawText(sanitizeText(formData.propertyData.propertyType), {
                x: 278.45,
        ...
        if (formData.propertyData && formData.propertyData.winterized) {
            page.drawText(sanitizeText(formData.propertyData.winterized), {
                x: 278.45,
        ...
        if (formData.propertyData && formData.propertyData.accessType) {
            page.drawText(sanitizeText(formData.propertyData.accessType), {
                x: 278.45,
        ...
        if (formData.propertyData && formData.propertyData.accessCode) {
            page.drawText(sanitizeText(formData.propertyData.accessCode), {
                x: 278.45,
            ...
            page.drawText(sanitizeText(formData.propertyData.lockboxAccessCode), {
                x: 278.45,
                y: 644.28 + Y_OFFSET - 100,
                size: 10,
                font: fontBold
        ...
        if (formData.propertyData && formData.propertyData.builtBefore1978) {
            page.drawText(sanitizeText(formData.propertyData.builtBefore1978), {
                x: 278.45,
        ...
        if (formData.commissionData) {
            ...
            if (formData.commissionData.totalCommissionPercentage) {
                page.drawText(sanitizeText(`Total Commission: ${formData.commissionData.totalCommissionPercentage}%`), {
                    x: 70.00,
                    y: currentY,
                    size: 10,
                    font
            ...
            if (formData.commissionData.buyersAgentPercentage) {
                page.drawText(sanitizeText(`Buyer's Agent: ${formData.commissionData.buyersAgentPercentage}%`), {
                    x: 70.00,
                    y: currentY,
                    size: 10,
                    font
            ...
            if (formData.commissionData.listingAgentPercentage) {
                page.drawText(sanitizeText(`Listing Agent: ${formData.commissionData.listingAgentPercentage}%`), {
                    x: 70.00,
                    y: currentY,
                    size: 10,
                    font
            ...
            if (formData.commissionData.sellersAssist) {
                page.drawText(sanitizeText(`Seller's Assist: $${formData.commissionData.sellersAssist}`), {
                    x: 70.00,
                    y: currentY,
                    size: 10,
                    font
            ...
            if (formData.commissionData.coordinatorFeePaidBy) {
                page.drawText(sanitizeText(`Coordinator Fee Paid By: ${formData.commissionData.coordinatorFeePaidBy}`), {
                    x: 70.00,
                    y: currentY,
                    size: 10,
                    font
        ...
        if (formData.additionalInfo) {
            ...
            if (formData.additionalInfo.specialInstructions) {
                ...
                const specialInstructions = sanitizeText(formData.additionalInfo.specialInstructions);
            ...
            if (formData.additionalInfo.urgentIssues) {
                ...
                // Split long text into multiple lines
                const urgentIssues = sanitizeText(formData.additionalInfo.urgentIssues);
