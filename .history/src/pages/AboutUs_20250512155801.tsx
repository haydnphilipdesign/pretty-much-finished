...
const CoreValue = ({ title, description, icon: Icon }: { title: string; description: string; icon: React.ComponentType<any> }) => (
  ...
  >
    <div className="glass-card-blue h-full transform group-hover:shadow-xl transition-all duration-300">
  ...
  return (
    <div className="relative bg-transparent">
      ...
      >
        <Link
          to="/work-with-me"
          className="inline-flex items-center mt-6 px-6 py-3 rounded-full bg-white hover:bg-white/90 text-blue-600 font-medium transition-all duration-300"
        >
          Get in Touch
          <motion.div
            className="ml-2"
      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center relative z-10">
          <div className="glass-card-navy max-w-4xl mx-auto">
            ...
            <Link
              to="/work-with-me"
              className="group inline-flex items-center px-8 py-4 text-lg font-medium text-blue-600 bg-white rounded-full shadow-lg hover:bg-white/90 transition-all duration-300"
            >
              Get in Touch
              <motion.div
                className="ml-2"
