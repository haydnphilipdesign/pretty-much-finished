    ...
    <div className="min-h-screen">
      ...
      <ContentSection dark={false} className="py-24 relative overflow-hidden" centered={true}>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto">Comprehensive solutions to streamline your real estate transactions</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <ContentCard
              ...
              className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 h-full"
            >
      ...
      >
        ...
        <div className="mb-12 text-center relative z-10">
          <HeroBadge className="mb-3">COMPREHENSIVE SOLUTIONS</HeroBadge>
          <h2 className="text-4xl font-bold text-brand-blue mb-3">Core Service Categories</h2>
          <p className="text-gray-700 max-w-3xl mx-auto">Our specialized services are designed to handle every aspect of your real estate transaction process</p>
        </div>
