...
// Create minimal sample HTML template that works with the PDF generator
function getSampleBuyerTemplate() {
  return `
<!DOCTYPE html>
<html>
<head>
...
function getSampleSellerTemplate() {
  return `
<!DOCTYPE html>
<html>
<head>
...
function getSampleDualAgentTemplate() {
  return `
<!DOCTYPE html>
<html>
<head>
...
async function createSampleTemplates() {
  const templates = {
    'Buyer.html': getSampleBuyerTemplate(),
    'Seller.html': getSampleSellerTemplate(),
    'DualAgent.html': getSampleDualAgentTemplate()
  };
  ...
  for (const [filename, content] of Object.entries(templates)) {
    ...
    try {
      ...
      console.log(`✅ Created/updated sample template: ${filename}`);
    } catch (error) {
