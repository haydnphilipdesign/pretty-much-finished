    ...
    try {
      ...
      if (result?.success) {
        ...
        try {
          ...
          const pdfResult = await sendTransactionPdfViaApi(formData);
          ...
          toast({
            title: "PDF Warning",
            description: "Transaction was saved but there was an issue generating the PDF: " + (pdfError.message || 'Unknown error'),
            variant: "destructive",
          });
        }
      } else {
