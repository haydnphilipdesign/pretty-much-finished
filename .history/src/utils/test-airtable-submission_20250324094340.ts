...
async function runTest() {
  try {
    ...
    console.log('Environment variables loaded:', {
      apiKey: import.meta.env.VITE_AIRTABLE_API_KEY ? 'Found' : 'Missing',
      baseId: import.meta.env.VITE_AIRTABLE_BASE_ID ? 'Found' : 'Missing',
      clientsTableId: import.meta.env.VITE_AIRTABLE_CLIENTS_TABLE_ID ? 'Found' : 'Missing'
    });
