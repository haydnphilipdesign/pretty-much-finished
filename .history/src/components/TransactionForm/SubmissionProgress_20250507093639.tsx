      ...
      >
        <div className="p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-1">
            {error ? "Submission Error" : "Processing Your Transaction"}
          </h2>
          ...
          <div className="space-y-4">
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center gap-3 bg-gray-50 p-2 rounded-lg">
          ...
          {error && onClose && (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={onClose}
              className="mt-4 w-full py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg font-medium transition-colors"
            >
              Close
            </motion.button>
          )}
