...
export type AgentRole = "BuyerSaAgent" | "Listing Agent" | "Dual Agent";
...
import { Select } from '../components/Select';
import { useDebounce } from '../hooks/useDebounce';
import { CommissionBase } from '../types/form.types';

const COMMISSION_BASES: CommissionBase[] = ["Full Price", "Net Price"];
