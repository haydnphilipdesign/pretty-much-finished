...
export function RoleSelection({ selectedRole, onRoleChange, onAutofill }: RoleSelectionProps) {
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 backdrop-blur-lg bg-white/90 border-white/30 text-slate-800 shadow-md rounded-xl">
        <div className="space-y-6">
          ...
          {/* Helper text about agent name */}
          <p className="text-sm text-slate-500 mt-2">
            <em>Note: You will enter your name later in the signature section.</em>
          </p>
