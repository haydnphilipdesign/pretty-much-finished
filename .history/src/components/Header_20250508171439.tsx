              ...
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    ...
                    } ${item.path === '/agent-portal' ? 'px-6 py-2 bg-gradient-to-r from-brand-blue to-brand-gold text-white rounded-lg hover:shadow-lg transition-all duration-300' : ''}`}
                  >
                    ...
                    {navItems.map((item) => (
                      ...
                      >
                        <Link
                          ...
                          } ${item.path === '/agent-portal' ? 'bg-brand-blue text-white hover:bg-blue-600' : ''}`}
                        >
