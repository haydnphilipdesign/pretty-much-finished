      ...
      <Card className="p-3 sm:p-6 backdrop-blur-lg bg-white/90 border-white/30 text-slate-800 shadow-md rounded-xl">
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            {role !== 'BUYERS AGENT' && (
              <div className="space-y-1.5 sm:space-y-2">
                <Label htmlFor="brokerFeeAmount">Broker Fee %</Label>
                <Input
                  id="brokerFeeAmount"
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Label>Referral Payment Method*</Label>
              <Select
                value={data.referralPaymentMethod}
                onValueChange={(value) => handleChange('referralPaymentMethod', value)}
              >
                <SelectTrigger id="referralPaymentMethod">
                  <SelectValue placeholder="Select one..." />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Label>Broker Payment Method*</Label>
              <Select
                value={data.brokerPaymentMethod}
                onValueChange={(value) => handleChange('brokerPaymentMethod', value)}
              >
                <SelectTrigger id="brokerPaymentMethod">
                  <SelectValue placeholder="Select one..." />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="CHECK">Check</SelectItem>
