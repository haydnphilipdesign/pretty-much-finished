...
export function StepWizard({ 
  ...
  return (
    <div className="w-full px-1 py-3" {...swipeHandlers}>      
      <div className="relative flex items-center justify-center flex-nowrap overflow-x-auto hide-scrollbar">
        {screenSize === 'small' && displaySteps.length < steps.length && (
          <button 
            ...
            className="absolute -top-8 right-0 text-white text-xs underline opacity-70 hover:opacity-100"
          >
        ...
        {/* Steps */}
        <div className="flex items-center space-x-1 md:space-x-2 px-1 min-w-full justify-between">
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isActive
                        ? "bg-gradient-to-r from-brand-gold to-brand-blue text-white shadow-md"
                        : isCompleted
                  ...
                  <span 
                    className={cn(
                      "text-[0.65rem] mt-1 font-medium hidden md:block whitespace-nowrap",
                      isActive 
                        ? "text-brand-blue" 
                        : isCompleted 
                        ? "text-gray-600" 
                  ...
                  >
                    {screenSize === 'large' ? step.title : step.shortTitle}
                  </span>
                </button>
