...
const SmoothNavigationProvider: React.FC<SmoothNavigationProviderProps> = ({
  ...
  // Set default values that create a more fluid transition
  scrollDuration = 400; // Faster scroll for better user experience
  scrollThreshold = 50; // Lower threshold to ensure we always scroll
  alwaysScrollToTop = true; // Always scroll to top for consistent experience
  heroVisibilityDelay = 200; // Shorter delay for more seamless transitions
