            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative glass-card p-8 text-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    ...
                    <a
                      href={method.link}
                      className="inline-flex items-center text-blue-300 font-medium hover:text-blue-200 transition-colors"
                    >
                      {method.action}
                      <motion.div
                        className="ml-2"
                  ...
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        required
                        className="w-full px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 focus:border-blue-400 text-white"
                      />
                    </div>
                    ...
                    {formStatus === 'success' && (
                      <div className="p-4 bg-green-500/20 backdrop-blur-sm rounded-lg border border-green-500/30 text-green-300">
                        Thank you for your message! I'll get back to you soon.
                      </div>
                    )}

                    {formStatus === 'error' && (
                      <div className="p-4 bg-red-500/20 backdrop-blur-sm rounded-lg border border-red-500/30 text-red-300">
                        {errorMessage}
                      </div>
                    )}
                  </form>
