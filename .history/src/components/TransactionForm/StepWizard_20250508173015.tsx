...
export function StepWizard({ 
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="flex flex-col items-center justify-center p-4 bg-white rounded-t-lg border-b">
        <div className="flex items-center gap-2 mb-2">
          <Image
            src="/pa-logo-icon.png"
            alt="PA Real Estate Support"
            width={32}
            height={32}
            className="w-8 h-8"
          />
          <h1 className="text-xl font-semibold text-gray-900">PA Real Estate Support</h1>
        </div>
        <h2 className="text-lg text-gray-600">Transaction Submission Portal</h2>
        <p className="text-sm text-gray-500 text-center mt-1">
          Streamlined transaction management for real estate professionals
        </p>
      </div>
