...
export function TransactionForm() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <div className="transaction-form-container flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
          {/* Step Wizard */} 
          <div className="wizard-container sticky top-0 z-20 bg-opacity-70 backdrop-blur-md">
            <StepWizard 
          ...
          <div className="container mx-auto px-2 sm:px-6 py-4 sm:py-6">
            ...
            <div ref={formContentRef} className="modern-form-container bg-white shadow-xl rounded-xl p-4 sm:p-8 border border-gray-100 mb-20 md:mb-0 relative">
