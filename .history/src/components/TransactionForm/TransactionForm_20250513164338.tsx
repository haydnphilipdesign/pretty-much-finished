...
import './TransactionForm.readability-fix.css'; // Import readability fixes
      ...
      <TooltipProvider>
        <div className="transaction-form-container flex flex-col">
          ...
          <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4">
            ...
            <div ref={formContentRef} className="modern-form-container bg-transparent backdrop-blur-sm shadow-xl rounded-xl p-3 sm:p-6 border border-white/20 mb-20 md:mb-0 relative">
              ...
              <div className="space-y-6 section-fade-in">
                {currentStep === 1 && (
                  <>
                      <div className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      {/* Enhanced section header with icon and gradient accent */}
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center rounded-full w-10 h-10 bg-gradient-to-br from-white/30 to-white/10 shadow-md mr-3 border border-white/20">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-white">Welcome to the Transaction Portal</h2>
                      </div>
                      <div className="border-t border-white/10 my-3"></div>
                      <p className="text-white/80 text-sm sm:text-base pl-2 border-l-4 border-white/30 ml-1">
                ...
                {currentStep === 8 && (
                  <>
                    ...
                    <div className="max-w-5xl mx-auto">
                      <div className="glass-effect bg-transparent rounded-xl p-6 border border-gray-200/30 shadow-lg relative overflow-hidden">
                ...
                {currentStep === 9 && (
                  <>
                    ...
                    <div className="max-w-5xl mx-auto">
                      <div className="glass-effect rounded-xl p-6 border border-gray-200/30 shadow-lg relative overflow-hidden">
