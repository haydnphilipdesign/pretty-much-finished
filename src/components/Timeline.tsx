      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
          ...
          <div className="col-span-full mb-2 text-center">
            ...
            >
              <h3 className="text-white text-xl font-medium">Early Career (1980s-1990s)</h3>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="w-full text-center z-[1000]">
                ...
                <div className="absolute top-8 left-0 w-full transform transition-all duration-500 ease-out translate-y-[10px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
                  <p className="text-[16px] font-bold text-[var(--text-color-hover)]">
                    {event.category}
                  </p>
                </div>
              </div>
              ...
              <div className="w-full text-center z-[1000] min-h-[4rem] flex items-center justify-center">
                <p className="text-[16px] font-bold text-[#1A202C] transform transition-all duration-500 ease-out group-hover:translate-y-[10px] group-hover:opacity-0">
                  {event.institution}
                  <br />
                  {event.date}
                </p>
                <div className="absolute bottom-8 left-0 w-full px-6 transform transition-all duration-500 ease-out translate-y-[-10px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
                  <p className="text-[15px] font-semibold text-[var(--text-color-hover)] leading-snug mb-0.5">
          ...
          <div className="col-span-full mt-12 mb-2 text-center">
            <motion.div
              ...
              className="inline-block px-6 py-1.5 bg-white/10 rounded-full"
            >
              <h3 className="text-white text-xl font-medium">Real Estate & Title Industry (2000-2006)</h3>
            </motion.div>
          </div>
          ...
          <div className="col-span-full mt-12 mb-2 text-center">
            <motion.div
              ...
              className="inline-block px-6 py-1.5 bg-white/10 rounded-full"
            >
              <h3 className="text-white text-xl font-medium">Specialist & Business Owner (2006-Present)</h3>
            </motion.div>
          </div>
