    ...
    <GlobalPageHero>
      <div className="container px-4 md:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <motion.div
                ...
                exit={{ opacity: 1, y: 0 }} /* Keep opacity at 1 during exit */
              ...
              >
                ...
                <HeroButton
                  ...
                  variant="ghost"
                  size="lg"
                  className="glass-card bg-white/10 text-white border border-white/20 rounded-full hover:bg-white/20 p-0 px-6 py-2.5"
                >
                  View Services
                </HeroButton>
              </motion.div>
          ...
          >
            <ContentCard heroStyle={true} className="bg-white/10 border border-white/20 p-8 rounded-2xl">
              {/* Stats section */}
