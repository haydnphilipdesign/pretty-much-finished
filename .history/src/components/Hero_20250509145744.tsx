  ...
  return (
    <GlobalPageHero>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4">
                <HeroButton
                  ...
                  variant="primary"
                  size="lg"
                  className="bg-brand-gold hover:bg-brand-gold/90 text-brand-blue rounded-full"
                  icon={
                    <motion.div
                      animate={{ x: [0, 5, 0] }}
        ...
        >
          <ContentCard heroStyle={true} className="bg-white/10 backdrop-blur-md border border-white/20 p-8">
            {/* Testimonial content */}
