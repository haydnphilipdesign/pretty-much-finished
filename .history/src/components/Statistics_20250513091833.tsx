...
const Statistics: React.FC = () => {
  return (
    <section className="py-24 relative overflow-hidden max-w-full statistics-section">
      {/* Enhanced background with more pronounced patterns for better visual effect */}
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-6xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold dark-bg-text mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              >
                <div className="text-3xl md:text-4xl font-bold mb-2 dark-bg-text">{stat.value}</div>
