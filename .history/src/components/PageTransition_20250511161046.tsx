...
const PageTransition: React.FC<PageTransitionProps> = ({ children }) => {
  ...
  // Scroll restoration on page change - even more aggressive approach
  useEffect(() => {
    ...
    // Then use requestAnimationFrame to ensure it happens as soon as the browser is ready
    ...
    // Also set up a MutationObserver to detect DOM changes and scroll to top again
    // This helps with dynamic content loading that might affect scroll position
