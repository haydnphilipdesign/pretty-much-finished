...
import { MissingFieldsIndicator } from "@/components/TransactionForm/MissingFieldsIndicator";
        ...
        <div className="relative min-h-screen bg-gradient-to-b from-blue-600 to-blue-900 pb-10 sm:pb-10 md:pb-10">
          ...
          <div className="container mx-auto px-2 sm:px-6 py-4 sm:py-6">
            ...
            <MobileNavBar 
              ...
              onPrevious={handlePrevious}
              onNext={handleNext}
              canGoNext={currentStep === 9 ? signatureData.signature && signatureData.infoConfirmed && signatureData.termsAccepted : true}
              isLastStep={currentStep === 9}
              hasMissingFields={getSkippedFieldList() && getSkippedFieldList().length > 0}
