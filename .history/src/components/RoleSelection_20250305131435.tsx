...
import { Home, Users, UserCheck, LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import { BaseSectionProps } from "./TransactionForm/types";

type AgentRole = "listing-agent" | "buyers-agent" | "dual-agent";
