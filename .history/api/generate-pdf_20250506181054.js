...
async function fillPdfForm(formData) {
    try {
        ...
        if (formData.commissionData) {
            ...
            if (totalCommission) {
                page.drawText(sanitizeText(`${totalCommission}`), {
                    x: 75,
                    y: 236.38 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (listingAgentCommission) {
                page.drawText(sanitizeText(`${listingAgentCommission}`), {
                    x: 75,
                    y: 289.24 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (buyersAgentCommission) {
                page.drawText(sanitizeText(`${buyersAgentCommission}`), {
                    x: 75,
                    y: 262.81 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (brokerFeeAmount) {
                page.drawText(sanitizeText(`$${brokerFeeAmount}`), {
                    x: 200,
                    y: 289.24 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (buyerPaidAmount) {
                page.drawText(sanitizeText(`$${buyerPaidAmount}`), {
                    x: 200,
                    y: 262.81 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
            ...
            if (sellersAssist) {
                page.drawText(sanitizeText(`$${sellersAssist}`), {
                    x: 396.44,
                    y: 690.52 + Y_OFFSET + 2,
                    size: 11,
                    font: fontBold
