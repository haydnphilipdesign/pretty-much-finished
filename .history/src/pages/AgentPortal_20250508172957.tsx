...
const AgentPortal = (): JSX.Element => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-gold via-gray-100 to-brand-blue/90">
          ...
          >
            ...
            <div className="flex-grow grid lg:grid-cols-5">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-brand-gold to-brand-blue">
                  <div className="absolute inset-0 bg-[url('/pattern-grid.svg')] opacity-20"></div>
                  {/* Decorative circles */}
                  <div className="absolute top-20 right-20 w-40 h-40 bg-brand-gold/20 rounded-full blur-xl"></div>
                  <div className="absolute bottom-20 left-20 w-60 h-60 bg-brand-blue/20 rounded-full blur-xl"></div>
                </div>
