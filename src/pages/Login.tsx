  ...
  return (
    <GlobalPageHero>
      <div className="container px-4 md:px-6 lg:px-8 mx-auto">
        ...
        >
            <div className="glass-card-navy relative p-6 md:p-8">
              {/* Decorative elements */}
            ...
            <div className="relative">
              ...
              <div className="flex justify-center mb-6">
                ...
                <h2 className="hero-card-title text-2xl font-bold text-center mb-6">Agent Login</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder="••••••••"
                        className="bg-white/20 border-white/30 focus:border-blue-400 text-white pr-10 shadow-sm"
                      required
                    />
                    <button
                      type="button"
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      ...
                      className="border-white/60 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500"
                  />
                  <label
                    htmlFor="rememberMe"
                  ...
                  {/* Error message */}
                {error && (
                    <div className="p-3 text-sm text-red-100 bg-red-500/30 backdrop-blur-sm rounded-md border border-red-500/30">
                    {error}
                  </div>
                )}
                ...
                <Button
                  type="submit"
                    className="hero-button w-full py-2 rounded-full shadow-md"
                  disabled={isLoading}
                >
                  {isLoading ? (
