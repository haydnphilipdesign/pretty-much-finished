  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A192F] to-[#112240] p-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Form Content */}
        <Card className="bg-white/20 backdrop-blur-xl shadow-2xl rounded-2xl p-8 border border-white/30 relative overflow-hidden">
          ...
          {state.currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <button
                  onClick={() => handleRoleSelection("buyersAgent")}
                  className={`p-6 rounded-xl border-2 transition-all ${state.selectedRole === "buyersAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                ...
                <button
                  onClick={() => handleRoleSelection("listingAgent")}
                  className={`p-6 rounded-xl border-2 transition-all ${state.selectedRole === "listingAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                ...
                <button
                  onClick={() => handleRoleSelection("dualAgent")}
                  className={`p-6 rounded-xl border-2 transition-all ${state.selectedRole === "dualAgent" ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'}`}
                >
                  <div className="flex flex-col items-center text-center space-y-4">
