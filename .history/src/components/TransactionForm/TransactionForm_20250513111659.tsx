...
export function TransactionForm() {
  ...
  useEffect(() => {
    // Increased delay to ensure DOM is fully updated and rendered before scrolling
    const scrollTimeout = setTimeout(() => {
      ...
      if (sectionTitle || formContent) {
        ...
        const targetPosition = targetElement ? targetElement.offsetTop - scrollOffset : 0;

        // First scroll to top to ensure consistent behavior
        window.scrollTo({
          top: 0,
          behavior: 'auto' // Use 'auto' for immediate scroll to top
        });

        // Then after a brief pause, scroll to the correct position
        setTimeout(() => {
        ...
        }, 100); // Small delay between scrolls
      }
    }, 250); // Increased delay to ensure DOM is fully updated and rendered
  ...
  const handleCustomStepClick = (step: number) => {
    ...
    // Add a delay before changing the step to ensure scroll completes
    setTimeout(() => {
      // Apply the step change
      handleStepClick(step);
      // Additional scrolling will happen via the useEffect when currentStep changes
    }, 150);
  };
  ...
  // Enhanced navigation functions to ensure proper scrolling
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <div className="transaction-form-container flex flex-col">
          {/* Step Wizard */}
          <div className="wizard-container sticky top-0 z-20 bg-blue-900/40 backdrop-blur-md border-b border-white/10">
            <StepWizard
              steps={formSteps.map(step => ({ ...step, completed: currentStep > step.id }))}
              currentStep={currentStep}
              onStepClick={handleStepClick}
              className="my-2 px-2 md:px-4"
              size="sm"
            />
          </div>
          ...
          <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4">
            ...
            <div ref={formContentRef} className="modern-form-container bg-white/90 backdrop-blur-sm shadow-xl rounded-xl p-3 sm:p-6 border border-white/20 mb-20 md:mb-0 relative">
              {/* Decorative corner accents for visual polish */}
              <div className="absolute top-0 left-0 w-16 h-16 border-t-4 border-l-4 border-blue-500/20 rounded-tl-xl pointer-events-none"></div>
              <div className="absolute top-0 right-0 w-16 h-16 border-t-4 border-r-4 border-blue-500/20 rounded-tr-xl pointer-events-none"></div>
              <div className="absolute bottom-0 left-0 w-16 h-16 border-b-4 border-l-4 border-blue-500/10 rounded-bl-xl pointer-events-none hidden md:block"></div>
              <div className="absolute bottom-0 right-0 w-16 h-16 border-b-4 border-r-4 border-blue-500/10 rounded-br-xl pointer-events-none hidden md:block"></div>
              ...
              <div className="space-y-6 section-fade-in">
                {currentStep === 1 && (
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        <div className="flex items-center justify-center rounded-full w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 shadow-md mr-3">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-white">
                            <path d="M14.5 22V12C14.5 10.8954 13.6046 10 12.5 10H6.5C5.39543 10 4.5 10.8954 4.5 12V22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M2.5 22H21.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M19.5 22V6C19.5 4.89543 18.6046 4 17.5 4H14.5C13.3954 4 12.5 4.89543 12.5 6V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M7.5 22V17H11.5V22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          </svg>
                        </div>
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Welcome to the Transaction Portal</h2>
                      </div>
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Property Information</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
                      <p className="text-gray-600 text-sm sm:text-base pl-2 border-l-4 border-blue-500/30 ml-1">
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Commission Details</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
                      <p className="text-gray-600 text-sm sm:text-base pl-2 border-l-4 border-blue-500/30 ml-1">
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Property & Title</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
                      <p className="text-gray-600 text-sm sm:text-base pl-2 border-l-4 border-blue-500/30 ml-1">
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Required Documents</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
                      <p className="text-gray-600 text-sm sm:text-base pl-2 border-l-4 border-blue-500/30 ml-1">
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Review Transaction</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
                      <p className="text-gray-600 text-sm sm:text-base pl-2 border-l-4 border-blue-500/30 ml-1">
                  ...
                  <>
                    <div id="section-title" className="pt-2 md:pt-4 mb-3 sm:mb-4 pb-2 sm:pb-3">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Sign & Submit</h2>
                      </div>
                      <div className="fancy-divider my-3"></div>
              ...
              <div className="flex flex-wrap justify-between items-center mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-200">
